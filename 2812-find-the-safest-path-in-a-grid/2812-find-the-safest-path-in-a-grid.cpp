...
1. Use BFS to find distance of each cell from thief
2. Use binary search to find maximum safety factor i.e. if it is possible to reach end with current safety factor or not
Time : O(n^2 * log(n^2))
Space : O(n^2)
*/
